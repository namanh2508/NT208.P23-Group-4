...
from api.views import CreatePatientUserView,AppointmentCreateView,GetAllDoctor,DoctorDetailView
...
urlpatterns = [
    ...
    path('api/appointments/<int:doctor_id>/', AppointmentCreateView.as_view(), name='create-appointment'),
